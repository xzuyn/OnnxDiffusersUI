...
def run_diffusers(
    ...
    # TODO: add option to select parameter step amount
        ...
        for guid in np.arange(
                firstguid, (lastguid + guid_direction), guid_direction
        ):
            print(
                f"guid {round(guid, 3)}/{lastguid} for video frames"
            )
...
# set img2img's pipe to use vae or textenc on cpu
def img2img_cpu():
    global textenc_on_cpu
    global vae_on_cpu
...
# set inpaint's pipe to use vae or textenc on cpu
def inpaint_cpu():
    global textenc_on_cpu
    global vae_on_cpu
...
# set legacy inpaint's pipe to use vae or textenc on cpu
def legacy_inpaint_cpu():
    global textenc_on_cpu
    global vae_on_cpu
...
if __name__ == "__main__":
    ...
    with gr.Blocks(title=title, css=custom_css) as demo:
        ...
        video_t0.change(
            fn=make_video1, inputs=video_t0, outputs=firstguid_t0, queue=False
        )
        video_t0.change(
            fn=make_video1, inputs=video_t0, outputs=lastguid_t0, queue=False
        )
        video_t0.change(
            fn=make_video2, inputs=video_t0, outputs=guid_t0, queue=False
        )
        video_t0.change(
        ...
        video_t1.change(
            fn=make_video1, inputs=video_t1, outputs=firstguid_t1, queue=False
        )
        video_t1.change(
            fn=make_video1, inputs=video_t1, outputs=lastguid_t1, queue=False
        )
        video_t1.change(
            fn=make_video2, inputs=video_t1, outputs=guid_t1, queue=False
        )
        video_t1.change(
        ...
        video_t2.change(
            fn=make_video1, inputs=video_t2, outputs=firstguid_t2, queue=False
        )
        video_t2.change(
            fn=make_video1, inputs=video_t2, outputs=lastguid_t2, queue=False
        )
        video_t2.change(
            fn=make_video2, inputs=video_t2, outputs=guid_t2, queue=False
        )
        video_t2.change(
